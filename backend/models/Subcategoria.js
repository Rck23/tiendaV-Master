 ...
 */
var SubCatagoriaEsquema = esquema({
 
  titulo: { type: String, required: true },

  categoria: { type: esquema.ObjectId, ref: 'categoria', required: true },
...
module.exports = mongoose.model("subcategoria", SubCatagoriaEsquema);
