...
<path class="text-primary" d="M62.0254 15.4219H64.418V18H62.0254V15.4219Z" transform="translate(0 -3)" fill="#9A6EE2"/>
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mx-auto">
              ...
              <li class="nav-item">
                <router-link class="nav-link" to='/shop'>Tienda</router-link>
              </li>
                  ...
                  <div class="row">
                    <div class="col-lg-9">
                      <div class="row p-3 pe-lg-0 ps-lg-5 pt-lg-5">
                        <div class="col-lg-3">
                          <!-- Megamenu list-->
                          <h6 class="text-uppercase">Inicio</h6>
                          ...
                          <!-- Megamenu list-->
                          <h6 class="text-uppercase">Tienda</h6>
                          <ul class="megamenu-list list-unstyled">
                        ...
                        <div class="col-lg-3">
                          <!-- Megamenu list-->
                          <h6 class="text-uppercase">Ordenes</h6>
                          <ul class="megamenu-list list-unstyled">
                        ...
                        <div class="col-lg-3">
                          <!-- Megamenu list-->
                          <h6 class="text-uppercase">Paginas</h6>
                          <ul class="megamenu-list list-unstyled">
                          ...
                          <ul class="megamenu-list list-unstyled">
                            <li class="megamenu-list-item"><a class="megamenu-list-link" href="customer-login.html">Inicio Sesión/Registro   </a></li>
                            <li class="megamenu-list-item"><a class="megamenu-list-link" href="customer-orders.html">Ordenes   </a></li>
                            <li class="megamenu-list-item"><a class="megamenu-list-link" href="customer-order.html">Orden detalle  </a></li>
                            <li class="megamenu-list-item"><a class="megamenu-list-link" href="customer-addresses.html">Direcciones   </a></li>
                            <li class="megamenu-list-item"><a class="megamenu-list-link" href="customer-account.html">Perfil   </a></li>
                          </ul>
                        </div>
                        <div class="col-lg-3">
                          <!-- Megamenu list-->
            ...
            <div class="d-flex align-items-center justify-content-between justify-content-lg-end mt-1 mb-2 my-lg-0">
                ...
                <div class="nav-item dropdown">
                    <a class="navbar-icon-link d-lg-none" href="cart.html">
                        <img src="/assets/icons/user.png" style="width: 25px;" />
                        <span class="text-sm ms-2 ms-lg-0 text-uppercase text-sm fw-bold d-none d-sm-inline d-lg-none">Carrito</span>
                    </a>
                    <div class="d-none d-lg-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-animated dropdown-menu-end p-4" aria-labelledby="cartdetails">
                            ...
                            <div class="d-flex justify-content-between">
                                <a class="btn btn-link text-dark me-3" href="cart.html">Carrito
                                  <img src="/assets/icons/shopping-bag.png" style="width: 15px;">
                                </a>
                                <a class="btn btn-outline-dark" href="checkout1.html">Ir a pago</a>
                            </div>
                        </div>
                    </div>
                </div>
