    ...
    <div>
        <div class="customer-sidebar card border-0"> 
            ...
            <nav class="list-group customer-nav">
                ...
                <router-link to="/cuenta/direcciones" active-class="active" class="active list-group-item d-flex justify-content-between align-items-center text-decoration-none"><span>
                    <svg class="svg-icon svg-icon-heavy me-2">
