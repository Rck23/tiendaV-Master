                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-6">
                            <div class="product">
                                ...
                                <div class="py-2">
                                    ...
                                    <h3 class="h6 text-uppercase mb-1"><a class="text-dark" href="detail.html">Skull Tee</a>
                                    </h3><span class="text-muted">$40.00</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-6">
                            <div class="product">
                                ...
                                <div class="py-2">
                                    <p class="text-muted text-sm mb-1">Denim</p>
                                    <h3 class="h6 text-uppercase mb-1"><a class="text-dark" href="detail.html">Blouse</a>
                                    </h3><span class="text-muted">$40.00</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="expand-lg collapse" id="categoriesMenu">
                        <div class="nav nav-pills flex-column mt-4 mt-lg-0" role="menu">
                            <div class="sidebar-menu-item mb-2 active" data-bs-toggle="collapse"
                                data-bs-target="#subcategories_0" aria-expanded="true" aria-controls="subcategories_0"
                                role="menuitem"><a class="nav-link active" href="#!"><span>Jackets</span><span
                                        class="sidebar-badge ms-2">123</span></a></div>
                            <div class="collapse show" id="subcategories_0">
                                <div class="nav nav-pills flex-column ms-3"><a class="nav-link mb-2" href="#!">Lorem
                                        ipsum</a><a class="nav-link mb-2" href="#!">Dolor</a><a class="nav-link mb-2"
                                        href="#!">Sit amet</a><a class="nav-link mb-2" href="#!">Donec vitae</a>
                                </div>
                            </div>
                            <div class="sidebar-menu-item mb-2" data-bs-toggle="collapse"
                                data-bs-target="#subcategories_1" aria-expanded="false" aria-controls="subcategories_1"
                                role="menuitem"><a class="nav-link " href="#!"><span>Jeans &amp; chinos</span><span
                            ...
                            <div class="sidebar-menu-item mb-2" data-bs-toggle="collapse"
                                data-bs-target="#subcategories_2" aria-expanded="false" aria-controls="subcategories_2"
                                role="menuitem"><a class="nav-link " href="#!"><span>Accessories</span><span
                                        class="sidebar-badge ms-2">80</span></a></div>
                ...
                <div class="sidebar-block px-3 px-lg-0 me-lg-4"><a class="d-lg-none block-toggler"
                    ...
                    <div class="expand-lg collapse" id="priceFilterMenu">
                        ...
                        <div class="nouislider-values">
                            ...
                            <input class="slider-snap-input" type="hidden" name="pricefrom" id="slider-snap-input-lower"
                                value="40">
                            <input class="slider-snap-input" type="hidden" name="priceto" id="slider-snap-input-upper"
                                value="110">
                        </div>
                    </div>
                </div>
