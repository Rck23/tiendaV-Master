              ...
              <div class="product">
                ...
                <div class="py-2">
                  ...
                  <h3 class="h6 text-uppercase mb-1">
                    <a class="text-dark" href="detail.html">White Tee</a>
                  </h3>
            ...
            <div class="col-xl-4 col-6">
              <div class="product">
                ...
                <div class="py-2">
                  ...
                  <h3 class="h6 text-uppercase mb-1">
                    <a class="text-dark" href="detail.html">Black blouse</a>
                  </h3>
                  <span class="text-muted">$40.00</span>
                </div>
              </div>
